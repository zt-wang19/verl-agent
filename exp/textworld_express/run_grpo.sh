...
export SWANLAB_PROJECT_NAME=textworld_express_grpo
...
# Make sure textworld_express is installed: pip install textworld_express
...
# Merge model after training (optional)
actor_path=$output_dir/global_step_${TOTAL_EPOCHS}/actor
sh exp/merge_model.sh ${actor_path}
NUM_GPUS=${NUM_GPUS} bash exp/textworld_express/test_repeat.sh ${actor_path}/huggingface
