...
DEFAULT_CHECKPOINT_PATH=/mnt/shared-storage-gpfs2/sfteval/lsz/spid/models/qwen2.5-7b-instruct
...
export SWANLAB_EXP_NAME=webshop_repeat_${CHECKPOINT_NAME}_test
output_dir=checkpoints/test_repeat_webshop/${CHECKPOINT_NAME}
mkdir -p $output_dir
