rjob submit \
    ...
    -- bash -c 'NUM_GPUS=8 SP_COEF=1 ID_COEF=0 bash /mnt/shared-storage-gpfs2/sfteval/lsz/spid/verl-agent/exp/alfworld/run_grpo.sh'


rjob submit \
    --name=spid-web-sp02id0 \
    --gpu=2 --memory=500000 --cpu=40 \
    --private-machine=group --charged-group=ptdata_gpu \
    --image=registry.h.pjlab.org.cn/ailab-ptdata-ptdata_gpu/lsz:lsz-ninja-20260104143512 \
    --mount=gpfs://gpfs1/lisongze:/mnt/shared-storage-user/lisongze \
    --mount=gpfs://gpfs2/sfteval/lsz/spid:/mnt/shared-storage-gpfs2/sfteval/lsz/spid \
    --custom-resources brainpp.cn/fuse=1 \
    --negative-tags node/gpu-lg-cmc-h-h200-2287.host.h.pjlab.org.cn \
    -- bash -c 'NUM_GPUS=2 SP_COEF=0.2 ID_COEF=0 bash /mnt/shared-storage-gpfs2/sfteval/lsz/spid/verl-agent/exp/webshop/run_grpo.sh /mnt/shared-storage-gpfs2/sfteval/lsz/spid/models/qwen2.5-7b-instruct'
